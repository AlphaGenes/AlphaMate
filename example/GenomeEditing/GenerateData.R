...
PopEdited10 = editGenomeTopQtl(pop = Pop, ind = 1:Pop@nInd, nQtl = 10)
...
plot(PopEdited10@gv ~ Pop@gv); abline(a = 0, b = 1)
...
prepareCriterionForAlphaMate(pop = Pop, popEdited = PopEdited10, file = "CriterionEdit10.txt")
...
sink(file = "AlphaMateSpecEdit10.txt")
cat("GenderFile                      , Gender.txt\n")
cat("NrmMatrixFile                   , Nrm.txt\n")
cat("SelCriterionFile                , CriterionEdit10.txt\n")
cat("OutputBasename                  , Edit10_\n")
cat("NumberOfMatings                 , 500\n")
cat("NumberOfMaleParents             ,  25\n")
cat("EqualizeMaleContributions       , Yes\n")
cat("NumberOfFemaleParents           , 500\n")
